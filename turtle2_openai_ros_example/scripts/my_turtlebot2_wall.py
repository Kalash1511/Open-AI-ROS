...
class MyTurtleBot2WallEnv(turtlebot2_env.TurtleBot2Env):
    def __init__(self):
        ...
        self.linear_hard_turn_speed = rospy.get_param('/turtlebot2/linear_hard_turn_speed')
        self.angular_hard_turn_speed = rospy.get_param('/turtlebot2/angular_hard_turn_speed')

        self.linear_soft_turn_speed = rospy.get_param('/turtlebot2/linear_soft_turn_speed')
        self.angular_soft_turn_speed = rospy.get_param('/turtlebot2/angular_soft_turn_speed')
    ...
    def _set_action(self, action):
        ...
        if action == 0: #FORWARD
            ...
            linear_speed = self.linear_hard_turn_speed
            angular_speed = self.angular_hard_turn_speed
            self.last_action = "hard_LEFT"
        elif action == 2: #RIGHT
            linear_speed = self.linear_hard_turn_speed
            angular_speed = -1*self.angular_hard_turn_speed
            self.last_action = "hard_RIGHT"

        elif action == 3: #LEFT
            linear_speed = self.linear_soft_turn_speed
            angular_speed = self.angular_soft_turn_speed
            self.last_action = "soft_LEFT"
        elif action == 4: #RIGHT
            linear_speed = self.linear_soft_turn_speed
            angular_speed = -1*self.angular_soft_turn_speed
            self.last_action = "soft_RIGHT"    
    ...
    def _compute_reward(self, observations, done):
        ...
        if not done:
            ...
            elif self.last_action == "hard_RIGHT":
                reward = self.hard_turn_reward 
            elif self.last_action == "hard_LEFT":
                reward = self.hard_turn_reward 

            elif self.last_action == "soft_RIGHT":
                reward = self.soft_turn_reward 
            elif self.last_action == "soft_LEFT":
                reward = self.soft_turn_reward 
